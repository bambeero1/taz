...
if os.path.isfile('dresses.html'):
    os.remove('dresses.html')
...
with open('dresses.html', 'w') as f:
    ...
    f.write(df.to_html(escape=False, index=False, classes='table table-hover'))
    f.write('\n</div>\n')
